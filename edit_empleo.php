...
$sql1 = "SELECT * FROM trabajos WHERE idetrab = $idTrabajo";
...
$arrArea = $stmtArea->fetchAll(PDO::FETCH_ASSOC);
              ...
              <div class="col-lg-10 offset-lg-1">
                <div class="p-4">
                  ...
                  <div class="container-fluid p-2 texto" style="background: #F0F0F0;"><br>
                    <h3 class="text-dark" style="text-align: center;"><strong> Editar Empleo </strong></h3>
                  </div>
                  ...
                  <form id="empleoregister" enctype="multipart/form-data">
                    ...
                    <div class="form-group form-label-group">
                      <input class="form-control labelchiquita" value="<?php echo $arr1[0]['nombre']; ?>" type="text" id="empleo" name="empleo" placeholder="Nombre del Empleo" style="border-radius: 50px;"/>
                      <label class="labelchiquita" for="empleo">Nombre del empleo *</label>
                    </div>
                    <br>
                    <!--Nombre del empleador o empresa/-->
                    <div class="form-group form-label-group">
                      <input class="form-control labelchiquita" value="<?php echo $arr1[0]['empleador']; ?>" type="text" id="empleador" name="empleador" placeholder="Nombre del Empleador" style="border-radius: 50px;"/>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-6">
                        ...
                        <input class="form-control form-control-user labelchiquita" value="<?php echo $arr1[0]['espec']; ?>" type="text" id="empEspecialidad" name="empEspecialidad" style="border-radius: 50px;"/>
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <!--Salario-->
                      <div class="col-sm-6"><label class="titulo">&nbsp;&nbsp;Salario: *</label><input class="form-control form-control-user labelchiquita my-2" type="number" value="<?php echo $arr1[0]['sal']; ?>" id="salario" name="salario" style="border-radius: 50px;"/></div>
                    </div>
                    <br>
                    <!--Ubicación/-->
                    <div class="form-group form-label-group">
                      <input class="form-control labelchiquita" type="text" value="<?php echo $arr1[0]['ubi']; ?>" id="empUbicacion" name="empUbicacion" placeholder="Ubicación" style="border-radius: 50px;"/>
                    ...
                    <!--Descripcion-->
                    <div class="form-group form-label-group">
                      <textarea class="form-control labelchiquita" type="text" id="empDescripcion" name="empDescripcion" placeholder="Descripcion" style="border-radius: 18px; height: 200px;"><?php echo $arr1[0]['descripcion']; ?></textarea>
                      <label class="texto" for="empdescripcion">Descripción del empleo *</label>
                    </div>
                    <br>
                    <!--Requisitos-->
                    <div class="form-group form-label-group">
                      <textarea class="form-control labelchiquita" type="text" id="empRequisitos" name="empRequisitos" placeholder="Requisitos" style="border-radius: 18px; height: 200px;"><?php echo $arr1[0]['requisitos']; ?></textarea>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-6">
                        <button class="btn btn-block text-white btn-user texto" style="background: #23B439; border-radius: 50px;" id="baccept" type="submit">Actualizar</button><hr></div>
        ...
        <script type="text/javascript">
          $(document).ready(function(){
            $("#empleoregister").submit(function(event){
              ...
              inputs.append("idTrabajo",'<?php echo $idTrabajo?>');
              event.preventDefault();
              $.ajax({
                type: "POST",
                url: "assets/php/empleo_update.php",
                data: inputs,
                cache:false,
                contentType: false,
                processData: false,
                success: function (data) {
                  console.log(data);
                  if(data == true){
                    toastr["success"]("Felicidades, el trabajo se actualizo correctamente.", "Trabajo actualizado.");
                  }else{
                    toastr["error"]("Lo siento, algo a salido mal y no se actualizo el trabajo.", "Error.");
                  }
                },error:function () {
                  toastr["error"]("Lo siento, algo a salido mal y no se actualizo el trabajo.", "Error2.");
                }
              });
            });
          });
